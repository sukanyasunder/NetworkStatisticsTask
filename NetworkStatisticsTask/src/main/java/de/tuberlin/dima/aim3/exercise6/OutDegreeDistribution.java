...
public class OutDegreeDistribution {
    ...
    public static void main(String[] args) throws Exception {
        ...
        DataSet<Tuple2<Long,LongValue>> degrees = graph.outDegrees();
        ...
        /* Write to file */
        degreeDistribution.writeAsCsv(Config.outputPath()+"out-degree_dist.csv", FileSystem.WriteMode.OVERWRITE)
                .setParallelism(1);

...
public class InDegreeDistribution {
    ...
    public static void main(String[] args) throws Exception {
        ...
        DataSet<Tuple2<Long,LongValue>> degrees = graph.inDegrees();
        ...
        /* Write to file */
        degreeDistribution.writeAsCsv(Config.outputPath()+"in-degree_dist.csv", FileSystem.WriteMode.OVERWRITE)
                .setParallelism(1);
